...
| 026 `auto_resume` setting, default in one place | `cdb31f7` | `tests/test_cli_auto_resume.py::test_default_is_on_and_lives_in_one_place` (named `..._is_off_...` when this report was written; the default was OFF then and v0.7's task 027 flipped it to ON, retargeting the test), `::test_default_literal_appears_exactly_once_in_the_source`, `::test_setting_survives_resume` |
...
| 030 roadmap note for the planned default flip | `c922587` | `tests/test_cli_auto_resume.py::test_roadmap_records_the_shipped_default_flip_and_names_the_single_place` (asserted the *planned* flip and was named `..._records_the_planned_...` when this report was written; v0.7's task 027 shipped the flip and retargeted the test) |
